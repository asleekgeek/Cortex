<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0219-mcp-server-core-pg-recall-signals.md; ADR-0219. Read-only mirror: edit the canonical wiki page. -->
