<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0352-mcp-server-handlers-consolidation-compression-py.md; ADR-0352. Read-only mirror: edit the canonical wiki page. -->
