<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0199-mcp-server-core-memory-domain-backfill.md; ADR-0199. Read-only mirror: edit the canonical wiki page. -->
