<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0197-mcp-server-core-memory-decomposer.md; ADR-0197. Read-only mirror: edit the canonical wiki page. -->
