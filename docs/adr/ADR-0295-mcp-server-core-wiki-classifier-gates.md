<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0295-mcp-server-core-wiki-classifier-gates.md; ADR-0295. Read-only mirror: edit the canonical wiki page. -->
