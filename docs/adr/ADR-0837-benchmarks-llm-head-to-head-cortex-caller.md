<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0837-benchmarks-llm-head-to-head-cortex-caller.md; ADR-0837. Read-only mirror: edit the canonical wiki page. -->
