<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0877-scripts-v3-13-0-a3-migration-sql.md; ADR-0877. Read-only mirror: edit the canonical wiki page. -->
