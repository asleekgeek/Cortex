<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0333-mcp-server-handlers-backfill-helpers-py.md; ADR-0333. Read-only mirror: edit the canonical wiki page. -->
