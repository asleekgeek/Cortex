<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0270-mcp-server-core-streaming-calibrated.md; ADR-0270. Read-only mirror: edit the canonical wiki page. -->
