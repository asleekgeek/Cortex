<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0115-mcp-server-core-capture-template-normalize.md; ADR-0115. Read-only mirror: edit the canonical wiki page. -->
