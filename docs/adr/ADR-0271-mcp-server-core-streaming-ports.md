<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0271-mcp-server-core-streaming-ports.md; ADR-0271. Read-only mirror: edit the canonical wiki page. -->
