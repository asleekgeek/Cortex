<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0354-mcp-server-handlers-consolidation-cycle-types-py.md; ADR-0354. Read-only mirror: edit the canonical wiki page. -->
