<!-- Generated by Cortex wiki_reindex from wiki/adr/cortex/0049-cortex-stays-local-managed-agents-migration.md; ADR-0049. Read-only mirror: edit the canonical wiki page. -->
