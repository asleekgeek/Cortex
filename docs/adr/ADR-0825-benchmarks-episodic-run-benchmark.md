<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0825-benchmarks-episodic-run-benchmark.md; ADR-0825. Read-only mirror: edit the canonical wiki page. -->
