<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0269-mcp-server-core-streaming-backpressure-pipeline.md; ADR-0269. Read-only mirror: edit the canonical wiki page. -->
