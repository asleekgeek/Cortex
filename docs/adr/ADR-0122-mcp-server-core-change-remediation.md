<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0122-mcp-server-core-change-remediation.md; ADR-0122. Read-only mirror: edit the canonical wiki page. -->
