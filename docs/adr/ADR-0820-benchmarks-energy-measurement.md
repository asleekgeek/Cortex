<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0820-benchmarks-energy-measurement.md; ADR-0820. Read-only mirror: edit the canonical wiki page. -->

---
title: "ADR-0820 — benchmarks/energy/measurement.py rationale"
status: accepted
source: benchmarks/energy/measurement.py
---

# ADR-0820 — benchmarks/energy/measurement.py
