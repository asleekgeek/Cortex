<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0346-mcp-server-handlers-consolidation-cascade-py.md; ADR-0346. Read-only mirror: edit the canonical wiki page. -->
