<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0088-benchmarks-lib-sweep-progress-py.md; ADR-0088. Read-only mirror: edit the canonical wiki page. -->
