<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0834-benchmarks-hnsw-probe-run-conditions-sql.md; ADR-0834. Read-only mirror: edit the canonical wiki page. -->
