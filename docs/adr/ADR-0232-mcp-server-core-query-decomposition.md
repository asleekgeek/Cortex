<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0232-mcp-server-core-query-decomposition.md; ADR-0232. Read-only mirror: edit the canonical wiki page. -->
