<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0240-mcp-server-core-replay-selection.md; ADR-0240. Read-only mirror: edit the canonical wiki page. -->
