<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0351-mcp-server-handlers-consolidation-cls-py.md; ADR-0351. Read-only mirror: edit the canonical wiki page. -->
