<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0221-mcp-server-core-pg-recall-weights.md; ADR-0221. Read-only mirror: edit the canonical wiki page. -->
