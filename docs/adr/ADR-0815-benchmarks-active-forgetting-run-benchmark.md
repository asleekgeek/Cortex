<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0815-benchmarks-active-forgetting-run-benchmark.md; ADR-0815. Read-only mirror: edit the canonical wiki page. -->
