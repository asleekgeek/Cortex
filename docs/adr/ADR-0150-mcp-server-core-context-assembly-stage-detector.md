<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0150-mcp-server-core-context-assembly-stage-detector.md; ADR-0150. Read-only mirror: edit the canonical wiki page. -->
