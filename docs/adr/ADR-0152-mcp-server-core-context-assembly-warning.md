<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0152-mcp-server-core-context-assembly-warning.md; ADR-0152. Read-only mirror: edit the canonical wiki page. -->
