<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0134-mcp-server-core-conflict-monitor.md; ADR-0134. Read-only mirror: edit the canonical wiki page. -->
