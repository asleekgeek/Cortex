<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0331-mcp-server-handlers-assess-coverage-py.md; ADR-0331. Read-only mirror: edit the canonical wiki page. -->
