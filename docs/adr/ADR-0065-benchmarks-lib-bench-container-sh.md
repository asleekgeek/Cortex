<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0065-benchmarks-lib-bench-container-sh.md; ADR-0065. Read-only mirror: edit the canonical wiki page. -->
