<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0343-mcp-server-handlers-consolidation-anchor-authoring-py.md; ADR-0343. Read-only mirror: edit the canonical wiki page. -->
