<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0266-mcp-server-core-streaming---init--.md; ADR-0266. Read-only mirror: edit the canonical wiki page. -->
