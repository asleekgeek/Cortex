<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0261-mcp-server-core-sparse-dictionary.md; ADR-0261. Read-only mirror: edit the canonical wiki page. -->
