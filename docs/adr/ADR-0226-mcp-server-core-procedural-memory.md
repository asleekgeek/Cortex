<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0226-mcp-server-core-procedural-memory.md; ADR-0226. Read-only mirror: edit the canonical wiki page. -->
