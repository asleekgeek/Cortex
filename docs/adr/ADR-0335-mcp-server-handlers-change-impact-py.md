<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0335-mcp-server-handlers-change-impact-py.md; ADR-0335. Read-only mirror: edit the canonical wiki page. -->
