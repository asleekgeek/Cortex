<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0358-mcp-server-handlers-consolidation-embedding-upgrade-py.md; ADR-0358. Read-only mirror: edit the canonical wiki page. -->
