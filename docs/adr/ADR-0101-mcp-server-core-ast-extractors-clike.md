<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0101-mcp-server-core-ast-extractors-clike.md; ADR-0101. Read-only mirror: edit the canonical wiki page. -->
