<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0075-benchmarks-lib-e2-subsample-runner-py.md; ADR-0075. Read-only mirror: edit the canonical wiki page. -->
