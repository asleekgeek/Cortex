<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0268-mcp-server-core-streaming-adaptive-writer.md; ADR-0268. Read-only mirror: edit the canonical wiki page. -->
