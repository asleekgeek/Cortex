<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0336-mcp-server-handlers-check-setup-py.md; ADR-0336. Read-only mirror: edit the canonical wiki page. -->
