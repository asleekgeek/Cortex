<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0875-scripts-phase-0-4-5-backfill-sql.md; ADR-0875. Read-only mirror: edit the canonical wiki page. -->
