<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0080-benchmarks-lib-machine-load-snapshot-py.md; ADR-0080. Read-only mirror: edit the canonical wiki page. -->
