<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0344-mcp-server-handlers-consolidation-authoring-prompts-py.md; ADR-0344. Read-only mirror: edit the canonical wiki page. -->
