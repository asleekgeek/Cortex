<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0109-mcp-server-core-auto-task-record.md; ADR-0109. Read-only mirror: edit the canonical wiki page. -->
