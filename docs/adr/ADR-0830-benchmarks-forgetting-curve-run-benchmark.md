<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0830-benchmarks-forgetting-curve-run-benchmark.md; ADR-0830. Read-only mirror: edit the canonical wiki page. -->
