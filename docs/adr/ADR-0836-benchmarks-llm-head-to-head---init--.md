<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0836-benchmarks-llm-head-to-head---init--.md; ADR-0836. Read-only mirror: edit the canonical wiki page. -->
