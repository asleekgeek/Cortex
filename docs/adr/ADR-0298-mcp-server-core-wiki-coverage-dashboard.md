<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0298-mcp-server-core-wiki-coverage-dashboard.md; ADR-0298. Read-only mirror: edit the canonical wiki page. -->
