<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0263-mcp-server-core-sparse-dictionary-learning.md; ADR-0263. Read-only mirror: edit the canonical wiki page. -->
