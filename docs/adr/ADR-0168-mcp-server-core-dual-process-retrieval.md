<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0168-mcp-server-core-dual-process-retrieval.md; ADR-0168. Read-only mirror: edit the canonical wiki page. -->
