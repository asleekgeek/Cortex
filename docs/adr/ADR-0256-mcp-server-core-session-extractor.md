<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0256-mcp-server-core-session-extractor.md; ADR-0256. Read-only mirror: edit the canonical wiki page. -->
