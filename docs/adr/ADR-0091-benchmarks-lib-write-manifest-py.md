<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0091-benchmarks-lib-write-manifest-py.md; ADR-0091. Read-only mirror: edit the canonical wiki page. -->
