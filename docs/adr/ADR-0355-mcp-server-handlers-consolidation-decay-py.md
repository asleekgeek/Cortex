<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0355-mcp-server-handlers-consolidation-decay-py.md; ADR-0355. Read-only mirror: edit the canonical wiki page. -->
