---
title: "ADR-0201 — mcp_server/core/memory_reheat.py rationale"
status: accepted
source: mcp_server/core/memory_reheat.py
---

# ADR-0201 — mcp_server/core/memory_reheat.py
...
## ReheatDecision — original line 85 (docstring)
...
## compute_reheat_target — original line 109 (docstring)

````text
Decide the new ``heat_base`` for one deliberate memory, never lowering.
````

## compute_reheat_target — original line 111 (docstring)
