---
title: "ADR-0221 — mcp_server/core/pg_recall_weights.py rationale"
status: accepted
source: mcp_server/core/pg_recall_weights.py
---

# ADR-0221 — mcp_server/core/pg_recall_weights.py
...
## compute_pg_weights — original line 76 (docstring)
